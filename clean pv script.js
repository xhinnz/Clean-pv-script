...
(function () {
    ...
    <div class="toolbar" style="position:fixed;top:0;left:0;right:0;padding:8px;background:#36393f;box-shadow: 0 1px 0 rgba(0,0,0,.2), 0 1.5px 0 rgba(0,0,0,.05), 0 2px 0 rgba(0,0,0,.05);">
        <div style="display:flex;flex-wrap:wrap;">
            <span>Authorization <a href="https://github.com/biel4cb/deleteDiscordMessages/blob/master/help/authToken.md" title="Help">?</a> <button id="getToken">auto</button><br>
                <input type="password" id="authToken" placeholder="Auth Token" autofocus>*<br>
                <span>Author <a href="https://github.com/biel4cb/deleteDiscordMessages/blob/master/help/authorId.md" title="Help">?</a> <button id="getAuthor">auto</button></span>
                <br><input id="authorId" type="text" placeholder="Author ID" priv></span>
            <span>Guild/Channel <a href="https://github.com/biel4cb/deleteDiscordMessages/blob/master/help/channelId.md" title="Help">?</a>
            ...
            <span>Range <a href="https://github.com/biel4cb/deleteDiscordMessages/blob/master/help/messageId.md" title="Help">?</a><br>
            ...
            <span>Search messages <a href="https://github.com/biel4cb/deleteDiscordMessages/blob/master/help/filters.md" title="Help">?</a><br>
    ...
    <pre style="margin-top:200px;font-size:0.75rem;font-family:Consolas,Liberation Mono,Menlo,Courier,monospace;">
        <center>Star this project on <a href="https://github.com/biel4cb/deleteDiscordMessages" target="_blank">github.com/biel4cb/deleteDiscordMessages</a>!\n\n
            <a href="https://github.com/biel4cb/deleteDiscordMessages/issues" target="_blank">Issues or help</a></center>
        </pre></body></html>`);
     ...
     * @author biel4 <https://www.github.com/biel4cb>
     * @see https://github.com/biel4cb/deleteDiscordMessages
     */
...
// @namespace     https://github.com/biel4cb/deleteDiscordMessages
// @version       4.0
// @match         https://discord.com/*
// @downloadURL   https://raw.githubusercontent.com/biel4cb/deleteDiscordMessages/master/deleteDiscordMessages.user.js
// @homepageURL   https://github.com/biel4cb/deleteDiscordMessages
// @supportURL    https://github.com/biel4cb/deleteDiscordMessages/issues
// @grant         none
// @license       MIT
// ==/UserScript==
 ...
 * @param {function} stopHndl stopHndl used for stopping
 * @author biel4 <https://www.github.com/biel4cb>
 * @see https://github.com/biel4cb/cleanpvscript.js
 * 
 */
async function deleteMessages(authToken, authorId, guildId, channelId, minId, maxId, content,hasLink, hasFile, includeNsfw, includePinned, extLogger, stopHndl, onProgress) {
    const start = new Date();
...
function initUI() {
    ...
    <div id="undiscord" style="display:none;">
        ...
        <div class="form">
            <div style="display:flex;flex-wrap:wrap;">
                <span>Authorization <a
                        href="https://github.com/biel4cb/deleteDiscordMessages/blob/master/help/authToken.md" title="Help"
                        target="_blank">?</a> <button id="getToken">get</button><br>
                    <input type="password" id="authToken" placeholder="Auth Token" autofocus>*<br>
                    <span>Author <a href="https://github.com/biel4cb/deleteDiscordMessages/blob/master/help/authorId.md"
                            title="Help" target="_blank">?</a> <button id="getAuthor">get</button></span>
                    <br><input id="authorId" type="text" placeholder="Author ID" priv></span>
                <span>Guild/Channel <a
                        href="https://github.com/biel4cb/deleteDiscordMessages/blob/master/help/channelId.md" title="Help"
                        target="_blank">?</a>
                ...
                <span>Range <a href="https://github.com/biel4cb/deleteDiscordMessages/blob/master/help/messageId.md"
                ...
                <span>Search messages <a
                        href="https://github.com/biel4cb/deleteDiscordMessages/blob/master/help/filters.md" title="Help"
                        target="_blank">?</a><br>
                    <input id="content" type="text" placeholder="Containing text" priv><br>
                    <label><input id="hasLink" type="checkbox">has: link</label><br>
                    <label><input id="hasFile" type="checkbox">has: file</label><br>
        ...
        <pre class="logarea">
            <center>Star this project on <a href="https://github.com/biel4cb/deleteDiscordMessages" target="_blank">github.com/biel4cb/deleteDiscordMessages</a>!\n\n
                <a href="https://github.com/biel4cb/deleteDiscordMessages/issues" target="_blank">Issues or help</a>
            </center>
        </pre>
    </div>
    `);
